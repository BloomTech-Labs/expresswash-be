...
| GET    | `/users/`                     | all users      | View all clients users.                                                    |
| GET    | `/users/:id`                  | all users      | View a client users.                                                       |
| DELETE | `/users/:id`                  | all users      | Remove a client users.                                                     |
| PUT    | `/users/:id`                  | all users      | Update a client users.                                                     |
